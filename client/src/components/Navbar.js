    ...
    const sideList = (
      <div className={classes.list}>
        <div className="navbar-drawer-header">
          ...
          <div className="navbar-drawer-text">Testprojekt</div>
        </div>
        <Divider />
        <List>
          {/* START LINK MENU */}
           ...
           <Link to="/bereichs">
            <ListItem button key="Bereich">
              <ListItemIcon>
                <ArrowForwardIos />
              </ListItemIcon>
              <ListItemText className="menu-text" primary="Bereich" />
            </ListItem>
          </Link>{" "}            
           <Link to="/tools">
            <ListItem button key="Tool">
              <ListItemIcon>
                <ArrowForwardIos />
              </ListItemIcon>
              <ListItemText className="menu-text" primary="Tool" />
            </ListItem>
          </Link>{" "} {/* END LINK MENU */}
        </List>
      </div>
